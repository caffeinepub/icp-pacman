...
export class Backend implements backendInterface {
    ...
    async getJackpotBalance(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getJackpotBalance();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPayoutWallet(): Promise<Principal | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPayoutWallet();
    ...
    async getTotalPlays(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalPlays();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setCountdown(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setPayoutWallet(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setPayoutWallet(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async startGame(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.startGame();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async triggerPayout(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.triggerPayout();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
